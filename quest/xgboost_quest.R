...
#       for (depth in max_depths) {
        ...
        tibble('Model' = 'Boosted Tree', 'Accuracy' = mean(validation_data_xgb$accuracy)) %>% kable()
...
tibble('Model' = 'Random Forest', 'Accuracy' = mean(validation_data_rf$accuracy)) %>% kable()
...
tibble('Model' = 'Bagging', 'Accuracy' = mean(validation_data_rf$accuracy)) %>% kable()
