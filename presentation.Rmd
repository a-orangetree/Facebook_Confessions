# Facebook Confessions Forum Data

#### Anonymous posts from college students. 

#### They have been manually label with regards to whether they concern a *taboo*.

#### Note: the indication of a *taboo* is not an indication of *content*.
...
## Are any of our categories more Narcissistic or Altruistic?

<br>

#### I-words = i, i'd, i've, i'll, i'm

#### U-words = you, u, ur, your, youre, you're, you'll, you'd
...
```{r, message=FALSE, echo=FALSE, warning=FALSE}
s1 <- summary
s1$cut_complete <- cutree(hierarchical_cluster_complete, 3)
kable(select(s1, label, cut_complete), align=c(rep('c',times=2)))
```
...
```{r, message=FALSE, echo=FALSE, warning=FALSE}
s1$cut_average <- cutree(hierarchical_cluster_avg, 3)
kable(select(s1, label, cut_average), align=c(rep('c',times=4)))
```
